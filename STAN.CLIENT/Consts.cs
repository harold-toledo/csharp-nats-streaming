...
namespace STAN.Client
{
    ...
    /// </summary>
    public static class StanConsts
    {
        /// <summary>
        ...
        /// </summary>
        public const string DefaultDiscoverPrefix = "_STAN.discover";

        /// <summary>
        /// DefaultACKPrefix is the prefix subject used to send ACKs to the NATS Streaming server.
        /// </summary>
        public const string DefaultACKPrefix = "_STAN.acks";
        ...
        internal const int ProtocolOne = 1;
    }
}
